...
import { tastepost1,tastepost2,tastepost0 } from '../reduxex/action/kind'
...
const Tastemakers = () => {
    ...
    return (
        <Container>
            ...
            <TasteMaker onMouseOver={() => mydispatch(tastepost1())} onMouseLeave={() => mydispatch(tastepost0())}>
                <TasteMakerImg src="img/skiz.png"></TasteMakerImg>
                <TasteMakerName>SKIZZY MARS</TasteMakerName>
            </TasteMaker>
            <TasteMaker onMouseOver={() => mydispatch(tastepost2())} onMouseLeave={() => mydispatch(tastepost0())}>
