...
import { tastepost2 ,tastepost0} from '../reduxex/action/kind'

const Tastepost2 = () => {
    const mydispatch = useDispatch();
    return (
        <Container onMouseOver={() => mydispatch(tastepost2())} onMouseLeave={() => mydispatch(tastepost0())}>
            <Description>
                <DescriptionTitle>
                    OUR 1ST TASTEMAKERS22222
                </DescriptionTitle>
                <DescriptionText>
